...
class SlipRingTestCase(unittest.IsolatedAsyncioTestCase):
    async def test_get_cool_down_time(self) -> None:
        ...
        data = [
            ...
            SlipRingTestData(
                max_power_drawn=mtdomecom.power_management.MAXIMUM_SLIP_RING_POWER_CAPACITY,
                time_over_limit=mtdomecom.power_management.MAXIMUM_OVER_LOW_LIMIT_TIME,
                expected_cool_down_time=mtdomecom.power_management.MAXIMUM_COOL_DOWN_TIME,
            ),
        ]
    ...
    async def test_get_available_power(self) -> None:
        ...
        with mock.patch("lsst.ts.mtdomecom.power_management.slip_ring.utils.current_tai") as mock_tai:
            ...
            assert slip_ring.state == mtdomecom.SlipRingState.BELOW_LOW_LIMIT
            ...
            for test_data in [
                CoolDownTestData(
                    tai=1.0,
                    power_drawn=mtdomecom.power_management.MAXIMUM_SLIP_RING_POWER_CAPACITY,
                    expected_power_available=mtdomecom.power_management.MAXIMUM_SLIP_RING_POWER_CAPACITY,
                    expected_state=mtdomecom.SlipRingState.OVER_LOW_LIMIT,
                ),
                CoolDownTestData(
                    tai=100.0,
                    power_drawn=0.0,
                    expected_power_available=0.0,
                    expected_state=mtdomecom.SlipRingState.COOLING_DOWN,
                ),
                CoolDownTestData(
                    tai=100.1,
                    power_drawn=0.0,
                ...
                CoolDownTestData(
                    ...
                    power_drawn=0.0,
                    expected_power_available=mtdomecom.power_management.MAXIMUM_SLIP_RING_POWER_CAPACITY,
                    expected_state=mtdomecom.SlipRingState.BELOW_LOW_LIMIT,
                ),
            ]:
            ...
            for test_data in [
                ...
                CoolDownTestData(
                    tai=mtdomecom.power_management.MAXIMUM_OVER_LOW_LIMIT_TIME + 2.0,
                    power_drawn=0.0,
                    expected_power_available=0.0,
                    expected_state=mtdomecom.SlipRingState.COOLING_DOWN,
                ),
                CoolDownTestData(
                    tai=mtdomecom.power_management.MAXIMUM_OVER_LOW_LIMIT_TIME
                    + mtdomecom.power_management.MAXIMUM_COOL_DOWN_TIME,
                    power_drawn=0.0,
                    expected_power_available=0.0,
                    expected_state=mtdomecom.SlipRingState.COOLING_DOWN,
                ),
