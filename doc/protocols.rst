...
.. _lsst.ts.mtdomecom-protocols:

#######################
Communication Protocols
#######################

This page describes the communication protocols used by the `MTDomeCom` class to communicate with the Lower Level Components.
...
.. literalinclude:: ../python/lsst/ts/mtdomecom/schema/apscs_status.py
   :language: python
...
.. literalinclude:: ../python/lsst/ts/mtdomecom/schema/lcs_status.py
   :language: python


This is the LWSCS status schema.

.. literalinclude:: ../python/lsst/ts/mtdomecom/schema/lwscs_status.py
   :language: python


This is the MonCS status schema.

.. literalinclude:: ../python/lsst/ts/mtdomecom/schema/moncs_status.py
   :language: python


This is the RAD status schema.

.. literalinclude:: ../python/lsst/ts/mtdomecom/schema/rad_status.py
   :language: python
